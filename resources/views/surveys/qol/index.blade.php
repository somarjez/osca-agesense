                        ...
                        <div class="flex justify-center gap-1.5">
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-cloak
                                     role="dialog" aria-modal="true" aria-labelledby="del-survey-title-{{ $survey->id }}"
                                     class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4"
                                     @keydown.escape.window="open = false">
                                    <div class="card max-w-sm w-full shadow-2xl" @click.outside="open = false">
                                        <div class="card-head">
                                            <div class="flex items-center gap-2.5">
                                                ...
                                                <h3 id="del-survey-title-{{ $survey->id }}" class="card-title">Delete QoL Survey?</h3>
                                            </div>
