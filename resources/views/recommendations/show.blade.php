...
<div class="space-y-5">
    ...
    <div role="tablist" aria-label="Recommendation categories"
         class="sticky top-0 z-10 flex flex-wrap gap-1 p-1 rounded-xl bg-paper-2 dark:bg-[#171c19] border border-paper-rule dark:border-[#2b3530]">
    ...
    <div class="card overflow-hidden" x-show="cat === 'all' || cat === '{{ $category }}'" x-cloak>
        ...
        <div class="divide-y divide-paper-rule">
            ...
            <div class="px-5 py-4 flex items-start gap-3 hover:bg-paper-2/50 dark:hover:bg-[#202a26]/40 transition-colors">
