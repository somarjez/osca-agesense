...
CSV_COLUMNS = [
    "timestamp", "consent", "first_name", "last_name", "middle_name", "name_ext",
    "dob", "age", "barangay", "gender", "marital_status",
    "religion", "ethnic_origin", "blood_type", "education",
...
def main() -> None:
    ...
    sql = f"""
        SELECT
            ...
            sc.ethnic_origin,
            sc.blood_type,
            IF(sc.consent_given_at IS NOT NULL, 'Yes', '') AS consent,
    ...
    with open(OUT_CSV, "w", newline="", encoding="utf-8-sig") as fh:
        ...
        for row in rows:
            ...
            out: dict = {
                ...
                "ethnic_origin":         row.get("ethnic_origin", "") or "",
