...
| `location_source` | `varchar(255)` NULL | `manual_pin` / `gps_capture` (verified) or `barangay_generalized` / `barangay_centroid` (generated) |
| `location_accuracy` | `varchar(255)` NULL | `verified/manual` (verified pin) or `barangay_level` / `approximate` (generated) |
